...
class Program
{
    static void Main()
    {
        ...
        Teacher t1 = new Teacher("Mr. Umbay", "OOP");
        Teacher t2 = new Teacher("Ms. Salangsaang", "Chemistry");
        ...
        House myHouse = new House("723 Balisong 514th Street");
        Console.WriteLine(myHouse.address + "has room: ");
        myHouse.ShowRooms();
    }
}
